...
import styled, {DefaultTheme, ThemeProps} from 'styled-components/macro';
...
export const FooterComponent: FunctionComponent<ClassNameOnly & ThemeProps<DefaultTheme>> = React.memo(({theme, className}) => {
    return (
