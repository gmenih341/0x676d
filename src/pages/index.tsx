...
import {HeaderComponentProps, PageComponent, ContentComponentProps} from '../types/PageComponent';
...
const ContentComponent: FunctionComponent<ContentComponentProps> = ({style}) => {
    return (
        <PageContent style={style}>
            <ConsoleContent className="experience">
                <SectionTitle>
                    <h2>Experience</h2>
                    <span>companies that paid me to write code</span>
                </SectionTitle>
                <WorkExperience />
            </ConsoleContent>
