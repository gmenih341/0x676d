...
export const COLOR_GRAY = ['#f0f2f4', '#d3d9de', '#b6bfc8', '#99a6b2', '#7c8c9c', '#637383', '#4d5966', '#374049', '#21262c', '#0b0d0f'];

export const COLOR_WHITE = COLOR_GRAY[0];
export const COLOR_BLACK = COLOR_GRAY[8];
